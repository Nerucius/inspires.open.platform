...
class ContentMaster(TrackableModel):
    ...
    name = models.CharField(max_length=512, unique=True, help_text="Internal use only. Create a name that identifies the content you will create.")
...
class Content(TrackableModel):
    ...
    topic = models.CharField(max_length=64, help_text="Define what this Article is about. Use single words and re-use them across articles.")
    title = models.CharField(max_length=512, help_text="Keep it short.")
